...
RSpec.describe "OpenEHR::Rails::Generators::ArchetypedBase", type: :generator do
  describe ArchetypedBase do
    let(:adl_file) { File.expand_path('../../templates/openEHR-EHR-OBSERVATION
...
../../templates/openEHR-EHR-OBSERVATION.blood_pressure.v1.adl', __FILE__))
      ...
      describe 'protected values' do
        let(:archetyped_base) {Openehr::Generators::ArchetypedBase.new([archetyp
e])}
        ...
        context 'model name' do
          it 'is origined form archetype id' do
            expect(archetyped_base.send(:model_name)).to eq 'open_ehr_ehr_observ
ation_blood_pressure_v1'
        ...
        context 'controller_name' do
          it 'is originated from archtype id' do
            expect(archetyped_base.send(:controller_name)).to eq 'open_ehr_ehr_o
bservation_blood_pressure_v1'      
          end
        end
      end
    end    
